...
class NpoApiClientsPagesITest {
    ...
    @Test
    void testGenres() throws JsonProcessingException {
        PageForm form =
    ...
    @Test
    void testPortal() throws JsonProcessingException {
        PageForm form =
            PageFormBuilder.form()
                .addPortals("VPRONL")
                .build();
    ...
    @Test
    void testSections() throws JsonProcessingException {
        PageForm form =
            PageFormBuilder.form()
    ...
    @Test
    void testPageType() throws JsonProcessingException {
        PageForm form =
            PageFormBuilder.form()
    ...
    @Test
    void testGenresFacets() throws JsonProcessingException {
        PageForm form =
            PageFormBuilder.form()
                .text("test")
                .genreFacet()
    ...
    @Test
    void testNPA186() throws IOException {
        PageForm form =
            PageFormBuilder.form()
                .text("Café 'de vogel'")
                .build();
    ...
    @Test
    void testNPA188() throws IOException {
        PageForm form =
            PageFormBuilder.form()
                .genres("3.0.1.8.30")
    ...
    @Test
    void testNPA193() throws JsonProcessingException {
        PageForm form =
            PageFormBuilder.form()
    ...
    @Test
    void testRelations() throws JsonProcessingException {
    ...
    @Test
    void testSortDate() throws JsonProcessingException {
       PageForm form =
            PageFormBuilder.form()
    ...
    @Test
    void testLastModified() throws JsonProcessingException {
    ...
    @Test
    @Disabled("Fails, but that can be expected with short time outs?")
    void testMGNL_14570() throws IOException {
